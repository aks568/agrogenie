...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2022 at 06:52 AM
...
--
-- Database: `agrogenietest`
--

-- --------------------------------------------------------

--
-- Table structure for table `agriproduce`
--

CREATE TABLE `agriproduce` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `agriproduce`
--

INSERT INTO `agriproduce` (`id`, `farmer_id`, `name`, `description`, `price`, `unit`, `image`) VALUES
(1, 2, 'Wheat', 'Whole grain wheat produced with great quality and care', 45, 'Per Kg', 'img/16.jpg');
...
(16, 1, 'New Product', 'Per Pack', 17500, 'img/1.jpg'),
(17, 1, 'Fertilizer', 'Per Pack', 175, 'img/1.jpg'),
(18, 1, 'Manure', 'Per 50 Kg', 3500, 'img/3.jpg');
...
(1, 'joe', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'joe', 'joe@m.com', '9384987483', 'dealer'),
(2, 'farmer', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'farmer', 'farmer@farmer.com', '9484757575', 'farmer'),
(3, 'abi', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'abi', 'abi@email.com', '8393847364', 'consumer');
...
--
-- Indexes for table `agriproduce`
--
ALTER TABLE `agriproduce`
  ADD PRIMARY KEY (`id`),
  ADD KEY `ForeignKey` (`farmer_id`);
...
--
-- AUTO_INCREMENT for table `agriproduce`
--
ALTER TABLE `agriproduce`
...
--
-- Constraints for table `agriproduce`
--
ALTER TABLE `agriproduce`
  ADD CONSTRAINT `ForeignKey` FOREIGN KEY (`farmer_id`) REFERENCES `user` (`id`);
