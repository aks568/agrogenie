...
<?php
    ...
    if(isset($_POST['upload']))
    {
        ...
        $img=$_POST['image'];
        $did = $_SESSION["id"];
        $sql=$db->query("INSERT INTO products (dealer_id, name, unit, price, image) VALUES('$did', '$pnm','$unit', $price, '$img')");
        if($sql){
    ...
    ?>
    <div class="main">Upload a Product<br><br>
        <form action="" method="POST">
            <input type="text" name="pname" placeholder="Product Name">
            <input type="text" name="price" placeholder="Price">
            <input type="text" name="unit" placeholder="Unit">
            <input type="text" name="image" placeholder="Image" value = "img/1.jpg">
            <!-- <select name="role">
