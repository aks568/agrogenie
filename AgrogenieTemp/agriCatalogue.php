...
<center><h1 style="font-family: 'Sacramento', cursive;font-size:45px;">Buy Directly from Farmers</h1></center>
...
$id = $_POST['id'];
$result = $db->query("SELECT * FROM `agriproduce` WHERE `id`='$id'");
...
<?php echo $status; ?>   
	<?php
    $result = $db->query("SELECT * FROM `agriproduce`");
...
<div class="new">
<img src="img/scart.png"/>&nbsp;<a href="agriCart.php" style="color:black">View Cart</a>
</div>